...
Phase 3.2 provider plugin framework is complete, and the repository is pending explicit approval
before Phase 3.3 begins. Future product functionality remains out of scope until that approval: do
