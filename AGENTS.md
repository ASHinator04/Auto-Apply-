...
Phase 3.4 Lever search connector and cross-provider consistency review are complete, and the
repository is pending explicit approval before Phase 3.5 begins. Future product functionality
remains out of scope until that approval: do not implement Ashby, browser automation,
authentication, AI providers, semantic retrieval, embeddings, answer suggestions, job normalization,
ranking, deduplication, storage, dashboard workflows, or application workflows.
