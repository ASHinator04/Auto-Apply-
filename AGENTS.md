...
Phase 4.3 Job Details & Evaluation is complete, and the repository is pending explicit approval
before Phase 4.4 begins. Future product functionality remains out of scope until that approval: do
not implement browser automation, authentication, AI providers, semantic retrieval, embeddings,
answer suggestions, storage, search sessions, application queues, application workflows, or Phase
4.4 Search Sessions work.
